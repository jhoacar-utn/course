...
//Estas lineas crean array de 4 posiciones donde cada casilla tendra el string seguido del indice
...
const get_response_array = function (coins, multipliers) {
    ...
    //porque sino los considera como strings y devolvera un ordenamiento como este:
    // [1 , 10 , 2, 22, 3, 34, 4] en vez de [1, 2, 3, 4, 10, 22, 34]
...
const calculate = function () {
    ...
    //Extraemos los valores de los inputs del DOM
    ...
    //Realizamos la verificacion que se hayan extraido la cantidad correcta
    ...
    load_response('response_total',response_total);
